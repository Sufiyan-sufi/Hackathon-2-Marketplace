...
const Navbar = () => {
  return (
    <div>
      <div className="Parent flex  justify-around gap-96 h-[84px]  bg-[#F0F2F3] items-center text-[#272343]">
      ...
      <div>
        <nav className="flex justify-around text-sm xl:text-base gap-96 text-[#636270] h-16 border-2 items-center">
